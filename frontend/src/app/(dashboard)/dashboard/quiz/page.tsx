...
export default function QuizDashboardPage() {
    ...
    return (
        <div className="space-y-6 md:space-y-10 max-w-full mx-auto pb-16 px-4 md:px-0">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 max-w-full">
                <div className="max-w-full">
                    <h1 className="font-display text-2xl md:text-4xl font-extrabold text-slate-900 flex items-center gap-3 break-words">
                        <Award className="h-8 w-8 md:h-10 md:w-10 text-[var(--orange)] shrink-0" />
                        Quiz Dashboard
                    </h1>
                ...
                <Link href="/dashboard/quiz/new" className="w-full md:w-auto">
                    <Button className="w-full md:w-auto bg-[var(--orange)] hover:bg-[var(--orange-dark)] text-white px-6 py-4 md:px-8 md:py-6 rounded-2xl font-bold shadow-lg shadow-orange-200 transition-all hover:scale-105 text-sm md:text-base">
